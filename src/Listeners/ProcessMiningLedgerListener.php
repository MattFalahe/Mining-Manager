...
/**
 * @deprecated Mining ledger processing is now handled via Queue::after hook and artisan commands.
 *             This listener will be removed in a future release.
 */
class ProcessMiningLedgerListener implements ShouldQueue
{
    ...
    {
        Log::warning('Mining Manager: ProcessMiningLedgerListener is deprecated. Mining ledger processing is now handled via Queue::after hook and artisan commands.');
