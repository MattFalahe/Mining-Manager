...
class DiscordRoleResolver
{
    ...
    /**
     * Snowflake-keyed lookup of all known roles across every detected
     * provider. Used by the Notification Routing Map partial to translate
     * stored role-mention IDs into human-readable names + colour swatches.
     */
     ...
     *
     * Accepts every shape the dispatcher accepts:
    ...
    /**
     * Describe a stored role-mention value for display in the routing map.
     *
     ...
     *     'name'   => 'Fuel Team' | null,   // resolved when kind=role and known
     *     'color'  => '#2ecc71' | null,
     *     'source' => 'discord-roles-table' | null,
     *     'known'  => bool,                 // true when ID resolves to a known role
     *   ]
     *
     * Pattern copied verbatim from Structure Manager's DiscordRoleResolver.
     *
