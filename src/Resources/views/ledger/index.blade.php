...
<div class="card card-dark card-tabs">
    <div class="card-header p-0 pt-1">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link {{ Request::is('*/ledger') && !Request::is('*/ledger/*') ? 'active' : '' }}" href="{{ route('mining-manager.ledger.index') }}">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="oreTypeFilter" name="ore_type">
                                        ...
                                        <option value="triglavian" {{ request('ore_type') == 'triglavian' ? 'selected' : '' }}>{{ trans('mining-manager::ledger.triglavian') }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
