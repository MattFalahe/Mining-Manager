                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {{-- Live confirmation box: shows both EVE and local interpretations --}}
...
$(document).ready(function() {
    ...
    // Parse a "YYYY-MM-DDTHH:mm" datetime-local string as UTC.
    ...
    // Parse the input by active mode → return Date pinned to a UTC instant.
    function parseByMode(value) {
        if (!value) return null;
        if (getInputMode() === 'local') {
            // Native Date on "YYYY-MM-DDTHH:mm" parses as LOCAL per spec.
    ...
    // UTC formatted as "YYYY-MM-DDTHH:mm" (datetime-local shape, UTC).
