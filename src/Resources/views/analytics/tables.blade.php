...
@section('full')
<div class="mining-manager-wrapper mining-dashboard analytics-tables-page">
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-body">
                    <form method="GET" action="{{ route('mining-manager.analytics.tables') }}" class="form-inline flex-wrap">
