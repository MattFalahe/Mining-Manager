...
return [
    ...
    'upfront_how_title' => 'How to Pay Ahead',
    'upfront_how_intro' => 'You can pay towards your mining tax before you are invoiced. The payment clears anything you already owe first, oldest invoice first, and the rest is held here and taken off your next invoices automatically.',
    'upfront_how_intro_not_held' => 'You can pay towards your mining tax before you are invoiced. The payment clears anything you already owe, oldest invoice first. Anything over that is not held for later, so send no more than you owe.',
    'upfront_how_step_give' => 'In game, right-click :corporation and choose "Give Money".',
    'upfront_how_your_corporation' => 'your corporation\'s name',
    'upfront_how_not_wallet' => '"Give ISK" in your own wallet can\'t send to a corporation.',
    'upfront_how_step_division' => 'If it asks for a wallet division, choose :division. If it doesn\'t, the ISK goes to the Master Wallet, which is also accepted.',
    'upfront_how_step_amount' => 'Enter how much you want to pay ahead.',
    'upfront_how_step_reason' => 'In the "Reason" field, put this keyword:',
    'upfront_how_no_tax_code' => 'Leave any tax code out. With a tax code in the reason, the payment goes to that invoice instead.',
    'upfront_how_step_send' => 'Confirm the transfer. It is picked up the next time the corporation wallet is checked, and then shows on this page.',
    'upfront_how_any_character' => 'You can send it from any character on your account.',
