...
return [
    ...
    'help_commands' => 'CLI Commands Reference',
    'help_commands_desc' => 'Run these commands via SSH using: php artisan command-name',
    'help_scheduled' => 'Scheduled Tasks',
    'help_scheduled_desc' => 'These commands run automatically on a schedule:',
    'help_developer' => 'Developer Tools',
    'help_developer_desc' => 'Diagnostic and debugging tools for administrators:',
    'help_diagnostics_link' => 'Access Diagnostics Page',
    'help_diagnostics_info' => 'The diagnostics page provides tools for testing price providers, validating type IDs, checking cache health, and more.',
    'help_moon_lifecycle' => 'Moon Extraction Lifecycle',
    'help_moon_lifecycle_desc' => 'Understanding moon extraction statuses:',
    'help_moon_extracting' => 'Extracting - Moon beam is active, chunk is forming',
    'help_moon_ready' => 'Ready - Chunk has arrived, belt is available for mining (0-48 hours)',
    'help_moon_unstable' => 'Unstable - Chunk will auto-fracture soon (48-51 hours)',
    'help_moon_expired' => 'Expired - Past natural decay time, belt has despawned',
    'help_troubleshooting' => 'Troubleshooting',
    'help_no_data' => 'If you see no data, run: php artisan mining-manager:process-ledger',
    'help_price_issues' => 'For pricing issues, check Settings → Pricing and test with diagnostics',
    'help_esi_issues' => 'For ESI/API issues, ensure corporation tokens have mining_observers scope',
    'every_30_min' => 'Every 30 minutes',
    'every_2_hours' => 'Every 2 hours',
    'every_4_hours' => 'Every 4 hours',
    'every_6_hours' => 'Every 6 hours',
    'twice_daily' => 'Twice daily (6 AM/PM)',
    'daily' => 'Daily',
