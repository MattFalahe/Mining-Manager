...
class TaxController extends Controller
{
    ...
    protected function getLiveTrackingData(string $mode = 'archived'): array
    {
        ...
        if ($mode === 'live') {
            ...
            // Archived mode: sum from daily summaries (generated by process-ledger and update-daily-summaries)
            // Daily summaries contain pre-calculated total_value and total_tax with correct per-ore tax rates
