...
- **Extraction Simulator and Find Moons** -- Simulate any scanned moon over 6 to 56 days with ore value, refined value, class and a quality rating against the scanned moons of its class, all priced from the price cache. **Find Moons** *(Director / Moon Manager / Moon Finder)* searches every scanned moon by region, constellation, system, security band, class, moon ore share, required ores, composition rules (R16 at least 20%), value range and quality, marks the moons one of your refineries still sits on and the ones you have marked as held by another corporation (either can be hidden), suggests better moons of the same class nearby, and exports the results to CSV.
