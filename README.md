...
- **Tax System** — Daily summary-based tax calculation with per-ore rates, multi-corporation support, guest mining rates, event modifiers, wallet payment verification, and manual payment entry
...
- **Notifications** — 15 notification types via Discord webhooks, Slack, and EVE Mail with per-webhook event toggles
