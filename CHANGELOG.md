...
- Wallet payment verification with tolerance matching
...
- 13 notification types: tax (reminder, invoice, overdue, generated), moon (arrival, jackpot), events (created, started, completed), theft (detected, critical, active, resolved), reports
